                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  Expanded(
                                    child: Text(
                                      'Faça parte do nosso time de vendedores agora!',
                                      textAlign: TextAlign.center,
                                      style: FlutterFlowTheme.of(context)
                                          .labelLarge
                                          .override(
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    Expanded(
                                      child: Text(
                                        'Envie sua foto do seu documento de identificação',
                                ...
                                Row(
                                  ...
                                  children: [
                                    Expanded(
                                      child: Text(
                                        'Pode ser CNH ou identidade que conheça o CPF',
                                        textAlign: TextAlign.start,
                                        style: FlutterFlowTheme.of(context)
                                            .labelLarge
                                            .override(
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  Expanded(
                                    child: Text(
                                      'Lembre-se de esta em um lugar iluminado para facilitar a aprovação do cadastro!',
                                      textAlign: TextAlign.start,
                                      style: FlutterFlowTheme.of(context)
                                          .labelLarge
                                          .override(
                                    ...
                                    FFButtonWidget(
                                      onPressed: () async {
                                        await currentUserReference!
                                          ...
                                          candidato: true,
                                          fotocandidato: _model.fotodovendedor,
                                          documentocandidato: _model.foto,
                                        ));
                                        await showDialog(
                                          context: context,
                                          builder: (alertDialogContext) {
                                            return AlertDialog(
                                              title:
                                                  Text('Cadastro em Analise!'),
                                              content: Text(
                                                  'Nossos operadores irão entrar m contato com você!'),
                                              actions: [
                                                TextButton(
                                                  onPressed: () =>
                                                      Navigator.pop(
