...
import 'freezer_model.dart';
export 'freezer_model.dart';

class FreezerWidget extends StatefulWidget {
  const FreezerWidget({super.key});

  static String routeName = 'FREEZER';
  static String routePath = '/freezer';

  @override
  State<FreezerWidget> createState() => _FreezerWidgetState();
}

class _FreezerWidgetState extends State<FreezerWidget> {
  late FreezerModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FreezerModel());
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          actions: [
            FFButtonWidget(
              onPressed: () async {
                context.pushNamed(CriarprodutosWidget.routeName);
              },
              text: 'Criar',
                          ...
                          child: StreamBuilder<List<ProdutosRecord>>(
                            ...
                            builder: (context, snapshot) {
                              ...
                              return MasonryGridView.builder(
                                ...
                                itemCount:
                                    staggeredViewProdutosRecordList.length,
                                shrinkWrap: true,
