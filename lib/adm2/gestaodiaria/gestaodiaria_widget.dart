...
import 'gestaodiaria_model.dart';
export 'gestaodiaria_model.dart';

class GestaodiariaWidget extends StatefulWidget {
  const GestaodiariaWidget({
    super.key,
  ...
  static String routeName = 'gestaodiaria';
  static String routePath = '/gestaodiaria';

  @override
  State<GestaodiariaWidget> createState() => _GestaodiariaWidgetState();
}

class _GestaodiariaWidgetState extends State<GestaodiariaWidget>
    with TickerProviderStateMixin {
  late GestaodiariaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GestaodiariaModel());
