...
import 'editarprodutos_model.dart';
export 'editarprodutos_model.dart';

class EditarprodutosWidget extends StatefulWidget {
  const EditarprodutosWidget({
    super.key,
    required this.prdoto,
  });

  final ProdutosRecord? prdoto;

  static String routeName = 'editarprodutos';
  static String routePath = '/editarprodutos';

  @override
  State<EditarprodutosWidget> createState() => _EditarprodutosWidgetState();
}

class _EditarprodutosWidgetState extends State<EditarprodutosWidget> {
  late EditarprodutosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditarprodutosModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      FFAppState().fotos = widget.prdoto!.imagens.toList().cast<String>();
      safeSetState(() {});
    });

    _model.nomeTextController ??=
        TextEditingController(text: widget.prdoto?.nome);
    _model.nomeFocusNode ??= FocusNode();

    _model.precoTextController ??=
        TextEditingController(text: widget.prdoto?.preco.toString());
    _model.precoFocusNode ??= FocusNode();

    _model.tipoTextController ??=
        TextEditingController(text: widget.prdoto?.tipo);
    _model.tipoFocusNode ??= FocusNode();

    _model.descircaoTextController ??=
        TextEditingController(text: widget.prdoto?.descricao);
    _model.descircaoFocusNode ??= FocusNode();

    _model.comissaoTextController ??= TextEditingController(
        text: formatNumber(
      widget.prdoto?.comissao,
                                      ...
                                      children: [
                                        Expanded(
                                          child: Container(
                                            ...
                                            child: TextFormField(
                                              controller:
                                                  _model.comissaoTextController,
                                              focusNode:
                                                  _model.comissaoFocusNode,
                                              autofocus: false,
                                              obscureText: false,
                                              decoration: InputDecoration(
                                                isDense: true,
                                              ...
                                              cursorColor:
                                                  FlutterFlowTheme.of(context)
                                                      .primaryText,
                                              validator: _model
                                                  .comissaoTextControllerValidator
                                                  .asValidator(context),
                                            ),
                                          ),
                                        ),
                                  ...
                                  Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        FFButtonWidget(
                                          onPressed: () async {
                                            await widget.prdoto!.reference
                                                .update({
                                              ...createProdutosRecordData(
                                                nome: _model
                                                    .nomeTextController.text,
                                                preco: functions
                                                    .recebestringretornadouble(
                                                        _model
                                                            .precoTextController
                                                            .text),
