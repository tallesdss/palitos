...
class DiariaStruct extends FFFirebaseStruct {
  DiariaStruct({
    ...
    FirestoreUtilData firestoreUtilData = const FirestoreUtilData(),
        ...
        _valorvendidoFinal = valorvendidoFinal,
  ...
  // "valorvendidoFinal" field.
  double? _valorvendidoFinal;
  double get valorvendidoFinal => _valorvendidoFinal ?? 0.0;
  set valorvendidoFinal(double? val) => _valorvendidoFinal = val;

  void incrementValorvendidoFinal(double amount) =>
      valorvendidoFinal = valorvendidoFinal + amount;

  bool hasValorvendidoFinal() => _valorvendidoFinal != null;

  static DiariaStruct fromMap(Map<String, dynamic> data) => DiariaStruct(
        ...
        valorvendidoFinal: castToType<double>(data['valorvendidoFinal']),
      );

  static DiariaStruct? maybeFromMap(dynamic data) =>
      data is Map ? DiariaStruct.fromMap(data.cast<String, dynamic>()) : null;
  ...
  Map<String, dynamic> toMap() => {
        ...
        'valorvendidoFinal': _valorvendidoFinal,
      }.withoutNulls;
  ...
  Map<String, dynamic> toSerializableMap() => {
        ...
        'valorvendidoFinal': serializeParam(
          _valorvendidoFinal,
          ParamType.double,
        ),
      }.withoutNulls;

  static DiariaStruct fromSerializableMap(Map<String, dynamic> data) =>
      DiariaStruct(
        ...
        valorvendidoFinal: deserializeParam(
          data['valorvendidoFinal'],
          ParamType.double,
          false,
        ),
      );
  ...
  @override
  String toString() => 'DiariaStruct(${toMap()})';

  @override
  bool operator ==(Object other) {
    return other is DiariaStruct &&
        ...
        valorvendidoFinal == other.valorvendidoFinal;
  }
...
DiariaStruct createDiariaStruct({
  DocumentReference? produto,
  double? valor,
  int? quantidade,
  String? nome,
  ...
  bool delete = false,
    ...
    DiariaStruct(
      ...
      valorvendidoFinal: valorvendidoFinal,
...
DiariaStruct? updateDiariaStruct(
  DiariaStruct? diaria, {
  bool clearUnsetFields = true,
  bool create = false,
}) =>
...
void addDiariaStructData(
  ...
  if (diaria.firestoreUtilData.delete) {
    firestoreData[fieldName] = FieldValue.delete();
    return;
  }
  final clearFields =
      !forFieldValue && diaria.firestoreUtilData.clearUnsetFields;
  if (clearFields) {
    firestoreData[fieldName] = <String, dynamic>{};
  }
  final diariaData = getDiariaFirestoreData(diaria, forFieldValue);
  final nestedData = diariaData.map((k, v) => MapEntry('$fieldName.$k', v));

  final mergeFields = diaria.firestoreUtilData.create || clearFields;
  firestoreData
      .addAll(mergeFields ? mergeNestedFields(nestedData) : nestedData);
}

Map<String, dynamic> getDiariaFirestoreData(
  DiariaStruct? diaria, [
  bool forFieldValue = false,
]) {
  if (diaria == null) {
  ...
  final firestoreData = mapToFirestore(diaria.toMap());

  // Add any Firestore field values
  diaria.firestoreUtilData.fieldValues.forEach((k, v) => firestoreData[k] = v);

  return forFieldValue ? mergeNestedFields(firestoreData) : firestoreData;
}

List<Map<String, dynamic>> getDiariaListFirestoreData(
  List<DiariaStruct>? diarias,
) =>
    diarias?.map((e) => getDiariaFirestoreData(e, true)).toList() ?? [];
